use eWFFORM
select  * from dbo.WF_FORMS
--연동 결재 중 아사히에서 사용자 있는지 확인 

select * from form_YC4EBC95FF8E44A87AD77392D2914166C WHERE CREATOR_DEPT like '%아사히%'  --예산부서월실적
...
select * from form_Y747BB57D3D334E53A0CA83F8BE4E379C WHERE CREATOR_DEPT like '%아사히%'order by suggestdate   -- 변동예산신청서
...
select top 100 * from form_YB9222DABFA484AC6AC97F2A23C649789 order by suggestdate   -- 거래처지원품의서(판촉지원)
select * from form_YB9222DABFA484AC6AC97F2A23C649789 WHERE CREATOR_DEPT like '%아사히%' order by suggestdate 
...
select * from form_Y1A35F931BEE0476E8119290B4240C7D2 WHERE CREATOR_DEPT like '%아사히%' order by suggestdate   --어음수표잔고명세서
...
Y8D4A994E63054A5EB14621BDD3A4483E   --구매의뢰서    (아사히 문건 따로 있음.)
select * from form_Y8D4A994E63054A5EB14621BDD3A4483E order by suggestdate --   2008-05-27 
...
select top 1 * from form_Y54CFE93E9F684353B8861A1B4644EAEE WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --5-27 판매용장비신청서
...
YA97EEB2C70C141EDA9A553E0135C7A0C
YA97EEB2C70C141EDA9A553E0135C7A0C	항목변경신청서
select top 1 * from form_YA97EEB2C70C141EDA9A553E0135C7A0C WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --5-27
...
Y3AAADA3BB0CE45D58106CDB1CA308EE1   --구매결의서   (아사히 문건 따로있음)
select * from form_Y3AAADA3BB0CE45D58106CDB1CA308EE1 order by suggestdate      --5-27
...
select top 1 * from form_YB8260780E3D44144AD24B38163F5AF88 WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --5-27
...
select * from form_Y6974AA653C114E53AC44157AA05F19EF WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --5-27
...
select top 1 * from form_Y761BB6954DC2408FA7927804B7E5BA4D WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --5-27
...
select top 1 * from form_Y42EF509649FD4AAA80646C681FDBF7B5 WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --5-27
...
select top 1 * from form_Y5149C2A149D24EADA29D306082EBA5F3 WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --5-27
...
select top 1 * from form_YFEA425C4FB9346D0B81C119099FB5F35 WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --5-27
...
select * from form_YB68D2E23A8F74970967B4D08912F0B9C WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2008-05-27
...
select top 1 * from form_Y35CED4073A514D94875F61A63FBE3666 WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2008-05-27
...
select top 1 * from form_Y462E36DD55F74F098C8A3D141BB0FCCF  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2008-05-27
...
select top 1 * from form_YDF9B8101D3C0454884DEDC383C620B71   WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2008-05-27
...
select top 1 * from form_Y85CE2A875E674904A4FAB9D7E50375BB  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2008-05-27  
...
select top 1 * from form_Y76D76F2606D748BE8E72C77D8B5D9AD9  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2008-05-27
...
select top 1 * from form_Y2AC6C1CC89A545C5A4350669B66271FA  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2008-05-27
...
select top 1 * from form_Y85DE0C0BF5FE4764954B2C71D6E86100  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2008-01-26
...
select top 1 * from form_Y7738807F64624140A4EEA15167EBEF82  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2008-04-07
...
select top 1 * from form_Y107F69F84EF742A9A10EE695EDFB56DC  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2008-05-07
...
select top 1 * from form_Y83BC2165F7D640D7ACD9BD062327106E  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2008-05-07
...
select top 1 * from form_Y816CA0D39251426586019F803013CB59  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2008-12-09
...
select top 1 * from form_Y9A282068897043E08905CD42881773D5  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2009-10-19
...
select top 1 * from form_YF57EBFF214194D0DB20F7B53FC26DEBE  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2010-05-13
...
select * from form_Y07D3A5CE2A10422982430EBECA4E93D9 WHERE SUGGESTDATE > '201505' order by suggestdate



YC05DF302C43742958445939F7E97CFF7   --구매결의서(아사히)
select top 1 * from form_YC05DF302C43742958445939F7E97CFF7 WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2010-06-30
select count(*) from form_YC05DF302C43742958445939F7E97CFF7 WHERE CREATOR_DEPT like '%아사히%'      --2010-06-30
select top 100 doc_name from form_YC05DF302C43742958445939F7E97CFF7  group by doc_name   --5602
...
select * from form_YC05DF302C43742958445939F7E97CFF7 WHERE SUGGESTDATE > '201505' order by suggestdate
...
select top 1 * from form_Y2B172D247B4B4E03A74ABC4B674FEA11 WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2010-04-20
...
select top 1 * from form_YAA6EC409DF3F41309D27D86DB9D606E7 WHERE CREATOR_DEPT like '%아사히%'  order by suggestdate      --2012-03-16
...
select top 1 * from form_Y0028F2733E8B449A8186BC8922E5DBFE  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2012-07-10
...
select top 1 * from form_Y58438F138FA641D9A31B8107F180129B  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2013-04-22
...
select top 1 * from form_Y7D123377DEBE43ED9EEADC93098C768E  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2013-11-07
...
select top 1 * from form_Y7B497D24B8DB4D3E99741B7D4DD76227  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2014-04-18
...
select top 1 * from form_Y4A71D90C86984A5E89158C23FFA0D19B  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2014-06-17
...
select top 1 * from form_Y00BE91A5F6794FEC83D8BFEEB4E897CD  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2014-06-27
...
select top 1 * from form_Y96114A5C446F45EAA7DED812C7BF1A54  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2014-08-26
...
select top 10 * from form_YB8BBB793520E47748E392E1234610027  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2014-12-01
...
select top 1 * from form_Y54C64AC297CD4218968B965CE9EA2482  WHERE CREATOR_DEPT like '%아사히%'  order by suggestdate      --2014-12-15
...
select top 1 * from form_Y34842D9B404A4D72A55DC5AED0C20BDC  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2014-12-15
...
select * from form_Y9818DD0694314EE3B0FD3157E6B21B81 WHERE CREATOR_DEPT like '%아사히%'  order by suggestdate    --2015-02-11
...
select top 1 * from form_Y6FDAA64B62544CF1B4ABAD28550BFE23  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2008-05-27
...
select top 1 * from form_Y8410F34EDFE44A6098AF6F9938C8F8C2 WHERE CREATOR_DEPT like '%아사히%'  order by suggestdate      --2008-05-27
...
select top 1 * from form_Y41917174934749BAA72F13D558BFDAD9 WHERE CREATOR_DEPT like '%아사히%'  order by suggestdate      --2014-12-05
...
select top 1 * from form_Y3EAF96CF291D44AD885E970420231CDD  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2014-12-15
...
select top 1 * from form_YA8A03008E3B44079A4C41705CDA97979 WHERE CREATOR_DEPT like '%아사히%'  order by suggestdate      --2008-05-27
...
Y0E59258A07B345E8864D70DB9531B186
select top 1 * from form_Y0E59258A07B345E8864D70DB9531B186  WHERE CREATOR_DEPT like '%아사히%'  order by suggestdate      --2008-05-27
...
select top 1 * from form_Y1154FBB3DE604374AABE54642BE7ADC5  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate      --2008-05-27
...
select top 1 * from form_YEF7F7187DC3F4AD48B2FC7308DEB9B28  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate   -- 2008-02-28
...
YCA1568A371EB4B81B78F2A0708B2461D
...
select top 1 * from form_YB979AF89EE92423B8F6A66C122F2E39E  WHERE CREATOR_DEPT like '%아사히%' order by suggestdate   -- 2013-08-01
...
select top 1 * from form_Y99738B95642141AABB7CCD387668E6FF WHERE CREATOR_DEPT like '%아사히%'  order by suggestdate   -- 2014-06-27
...
select top 1 * from form_Y80F6EE6C87564C248CD342E46C890AE9 WHERE CREATOR_DEPT like '%아사히%'  order by suggestdate   -- 2015-01-17
